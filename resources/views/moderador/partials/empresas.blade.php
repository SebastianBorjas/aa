...
<div class="p-4" x-data="{ isFormOpen: {{ $errors->any() ? 'true' : 'false' }}, editId: null }">
  <!-- Button to toggle the registration form -->
  <button 
    x-on:click="isFormOpen = !isFormOpen; editId = null" 
    class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition font-medium mb-4"
  >
    <span x-text="isFormOpen ? 'Ocultar Formulario' : 'Registrar Nueva Empresa'"></span>
  </button>
  ...
  <div 
    ...
    x-cloak
    class="bg-white rounded-lg shadow-md p-6 max-w-md mb-6"
  >
  ...
  <div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-xl font-semibold text-gray-900 mb-4">Lista de Empresas</h2>
    @if ($empresas->isEmpty())
            ...
            @foreach ($empresas as $empresa)
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button 
                    x-on:click="editId = editId === {{ $empresa->id }} ? null : {{ $empresa->id }}; isFormOpen = false"
              ...
              <!-- Edit Form -->
              <tr x-show="editId === {{ $empresa->id }}" x-cloak>
